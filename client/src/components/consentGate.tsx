...
const ConsentGate: React.FC<{ roomID: string; active: boolean }> = ({ roomID, children, active }) => {
  ...
  return  consentPassed ? (
    ...
    <div className="fullBleed absolute faintWhiteFill highest">
      <div className="center:absolute stack padded" style={{ width: "80%", height: "70%" }}>
        ...
        <div className="horizontal-stack">
          <div className="clickable padded lightFill border contrastFill:hover" onClick={() => {console.log("SETTING", roomID); setConsent(roomID)}}>
            proceed
          </div>
        </div>
      </div>
