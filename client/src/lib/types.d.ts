...
// Custom type interface for additional CSS variables, as defined in globals.css.
interface ThingCSSProperties extends React.CSSProperties {
  "--stickerSize"?: string;
  "--stickerGlowShadow"?: string;
  "--chatBorderColor"?: string;
  "--chatAuthorColor"?: string;
